...
<main class="dashboard">
    <header class="dashboard-header"><div><p class="eyebrow">THE DAILY NEWS</p><h1>Published articles</h1><p>Signed in as <?= htmlspecialchars($_SESSION["name"]) ?></p></div><a class="button-link" href="dashboard.php">Dashboard</a></header>
